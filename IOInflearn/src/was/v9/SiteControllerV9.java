...
public class SiteControllerV9 extends Controller {
    @RequestMapping
    ...
    public void page1(HttpResponse httpResponse){
        StringBuilder str = new StringBuilder();
        //String site = "site "+"";
    ...
    public void page2(HttpResponse httpResponse){
        StringBuilder str = new StringBuilder();
        //String site = "site "+"";
    ...
    //duplication check
//    @RequestMapping(requestPath = RequestConstants.SITE_2)
//    public void page3(HttpResponse httpResponse){
//        StringBuilder str = new StringBuilder();
//        //String site = "site "+"";
//        str.append("<h1>site 3</h1>");
//
//        httpResponse.statusCode= Constants.SUCCESSFUL_CODE;
//        httpResponse.responseBody=str;
//    }
