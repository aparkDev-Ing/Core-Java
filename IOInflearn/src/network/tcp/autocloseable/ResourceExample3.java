        ...
        try {
            ...
            if(resource2 != null){
                try {
                    ...
                    // Nothing much for developer to do if this exception occurs - therefore, leaving a log to analyze it for later and let it continue
                    System.out.println("Exception occured while closing resource: "+e);

                    // in order to resolve all these issues except issue 1 readability
                    //  2- Not able to close and Leaving other resources opened, 3- Important business logic exception getting replaced with resource close exception
                    // but, it still does not resolve a readability issue and requires a lot of complex code
                }
