...
public class NetworkingMainServerV4 {
        ...
        while(true)
         {
             ...
             SessionV4 session = new SessionV4(socket, new DataInputStream(socket.getInputStream()), new DataOutputStream(socket.getOutputStream()));
         }
