...
public class WhenCompleteExample {
    ...
    static void launchApplication() throws InterruptedException{
        ...
        CompletableFuture<String> cf1 = CompletableFuture.supplyAsync(()->deliverFood(order)).whenComplete((r,t)->{

            if(t!=null){
                System.out.println(Thread.currentThread().getName() +" has failed to delivery due to:: "+t);
            }
            else{
                System.out.println("Delivery Result: "+r);
            }
        });
