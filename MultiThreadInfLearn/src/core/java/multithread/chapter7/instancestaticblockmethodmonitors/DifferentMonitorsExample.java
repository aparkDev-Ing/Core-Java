...
public class DifferentMonitorsExample {
    ...
    public static void main(String[] args){
        ...
        DifferentMonitorsExample example1 = new DifferentMonitorsExample();
        DifferentMonitorsExample example2 = new DifferentMonitorsExample();
